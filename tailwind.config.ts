...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-premium': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(220 100% 60%) 50%, hsl(190 100% 50%) 100%)',
        'gradient-hero': 'linear-gradient(135deg, hsl(220 60% 15%) 0%, hsl(220 40% 25%) 50%, hsl(200 50% 30%) 100%)',
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "50%": { boxShadow: "0 0 40px rgba(13, 110, 253, 0.5)" },
        },
        "shimmer": {
