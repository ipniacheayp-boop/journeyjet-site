...
const sitemapFiles = readdirSync(resolve(ROOT, "public"))
...
- **Sitemap split.** Hotel *city* pages live in \`sitemap-hotels.xml\`. Other indexable URLs are split across \`sitemap.xml\`, \`sitemap-destinations.xml\`, \`sitemap-flights.xml\`, \`sitemap-cruises.xml\`, and \`sitemap-hotel-places.xml\`. No URL appears in more than one file.
