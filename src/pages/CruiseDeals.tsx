  ...
  const cruiseDeals = [
    {
      ...
      price: 180,
      benefits: ["Instant savings up to 25%", "Free Gratuities", "Exclusive discount for 2nd Guest"],
    ...
    },
    {
      ...
      price: 300,
      benefits: ["Instant Savings up to 20%", "Onboard Credit", "Free Gratuities"],
    ...
    },
    {
      ...
      price: 280,
      benefits: ["Instant savings up to 20%", "Free Gratuities", "Exclusive discount for 2nd Guest"],
    ...
    },
    {
      ...
      price: 600,
      benefits: ["Up to 15% off", "Onboard Credit", "Free Gratuities"],
    ...
    },
    {
      ...
      price: 1015,
      benefits: ["Instant savings up to $150", "Free Gratuities", "Onboard Credit and more"],
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background pt-20">
        <SEOHead
          title="Best Cruise Deals & Vacation Offers | Tripile"
        ...
        >
          ...
          <div className="container mx-auto text-center relative z-10">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8">Up to 25% off on Major Cruise Lines</p>
            <Link to="/contact-us">
              <Button
                size="lg"
                    ...
                    <div className="flex items-center gap-4 text-muted-foreground mb-3">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm">
                          {deal.title.split(" ")[0]} {deal.title.split(" ")[1]}
                        </span>
                      </div>
                    </div>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground dark:prose-invert">
              <p className="mb-6">
                ...
                we've curated the best cruise packages from the world's most renowned cruise lines.
              </p>
              <p className="mb-6">
                Our exclusive partnerships with Royal Caribbean, Carnival, Norwegian, Celebrity, Princess, and Holland
                America allow us to offer you unbeatable prices with added perks like free gratuities, onboard credits,
                and exclusive discounts for second guests. From budget-friendly getaways to luxurious voyages, there's a
                perfect cruise waiting for you.
              </p>
              <p className="mb-6">
                Experience world-class dining, entertainment, and amenities while visiting breathtaking destinations.
                Our travel experts are available 24/7 to help you find the perfect cruise that fits your budget and
                preferences. Don't miss out on these limited-time offers – call now to secure your spot on the cruise of
                your dreams!
              </p>
              <p>
                With flexible booking options and our best price guarantee, you can book with confidence knowing you're
                getting the best value for your vacation. Start your journey today and create memories that will last a
                lifetime.
              </p>
            </div>
          </div>
