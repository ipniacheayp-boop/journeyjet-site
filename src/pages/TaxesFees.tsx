...
const TaxesFees = () => {
  ...
  const feesAndTaxes = [
    ...
    },
    {
      name: "U.S. Excise Tax",
      description:
        "This tax is a small percentage of flights that is applicable to all flights routed within the United States. Also applicable to flights within the Canada/Mexico 225-mile buffer zones.",
      applicableTo: "U.S. Domestic and International",
      code: "US",
      price: "7.50%",
    },
    {
      ...
      description:
        "This facility charge is a variable fee applicable on per itinerary for improvement of passenger facility at the airport.",
      applicableTo: "U.S. Domestic and International",
      code: "XF",
      price: "up to $18.00",
    },
    {
      ...
      description:
        "This is a security fee about $5.60 per one way based on the total number of passengers boarding the flight.",
      applicableTo: "U.S. Domestic and International",
      code: "AY",
      price: "$11.20",
    },
    {
      ...
      description:
        "This tax is applicable to all flights routed to and from the United States, U.S Virgin Islands or Puerto Rico.",
    ...
    },
    {
      ...
      description:
        "This fee is applicable to cover the cost of inspection fees, security fees and various other taxes levied according to international norms.",
      applicableTo: "International",
      code: "Varies",
      price: "up to $349.00*",
    },
    {
      ...
      description:
        "Online Air Transaction Services Fees - Depending on the cabin type, trip type and certain other factors, a service fee of up to $100.00 is charged per person for all passenger types**",
      applicableTo: "U.S. Domestic and International",
      code: "Fees",
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <section className="mb-12">
            ...
            <ul className="mt-6 space-y-3 text-sm text-muted-foreground list-disc list-inside">
              <li>
                Trips where you visit multiple cities and return home/city of origin from the city you visited last - Up
                to $100.00 chargeable per passenger as service fee irrespective of the passenger type ticket.
              </li>
              <li>
                Multi airline trips / Cities with staggering rate of frauds - Up to $50.00 chargeable per passenger as
                service fee irrespective of the passenger type ticket.
              </li>
              ...
              <li>
                Service fees on bookings made through customer care center - For bookings made through customer care
                center including round-the-world as well as complex multi-stop itineraries, the service fee chargeable
                may be higher than the one applicable when the bookings are made online. This service fee is between
                $10.00 and $200.00. Senior citizens are charged up to only $100.00. Premium package benefits are
            ...
            <div className="mt-6 p-4 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg">
              <p className="text-sm font-medium text-amber-800 dark:text-amber-200">
                <strong>NOTE:</strong> All services fees are subject to change without notice. YOU WILL BE CHARGED THE
                FINAL TOTAL PRICE AS QUOTED REGARDLESS OF ANY CHANGES OR VARIANCE IN THE FEES. Kindly review the total
                final price carefully.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                <sup>(1)</sup> All post-ticketing service fees mentioned above are per passenger, per transaction, and
                are in addition to any airline-imposed fees, fare differences, and applicable taxes. These fees are
                non-refundable regardless of whether the underlying ticket is refundable or not.
              </p>
              <p>
              ...
              <p>
                The fees listed above are subject to change without prior notice. Airlines reserve the right to modify
                their own change and cancellation policies at any time. Customers are advised to review the complete
              ...
              <p>
                For group bookings (10 or more passengers), different fee structures may apply. Please contact our
                dedicated group travel desk for accurate pricing and policy information.
              </p>
              <p>
                ‡‡ Post-ticketing service fees are charged per passenger per transaction and are in addition to any
                airline-imposed penalties or fare differences. All fees are non-refundable.
              </p>
            </div>
          </section>
          ...
          <section className="text-center py-8 bg-primary/5 rounded-lg">
            ...
            <p className="text-muted-foreground mb-6">
              Our support team is available to answer any questions about charges and policies.
            </p>
