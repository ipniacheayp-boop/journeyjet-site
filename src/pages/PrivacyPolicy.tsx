  ...
  return (
    <div className="p-6 md:p-12">
      ...
      <P>
        ...
        content, functionality, and services offered on or through tb.com or the App (collectively herein the
        "Website"), as well as our practices for collecting, using, maintaining, protecting, sharing, and disclosing
        that information.
      </P>
      ...
      <ul>
        ...
        <Li>
          When you interact with our advertising and applications available on third-party websites and services if
          those applications or advertising include links to this Policy.
        </Li>
      </ul>
      <P className="mt-4">This Policy does not apply to information collected by:</P>
      <ul>
        <Li>
      ...
      <P className="mt-4">
        ...
        will treat it. This Policy may change from time to time (see "Changes to Our Privacy Policy"). Please check the
        Policy periodically for updates.
      </P>

      <SubHeading>Children Under the Age of 13</SubHeading>
      <P>
        Our Website is not intended for, intentionally targeted to, or designed for use by children under 13 years of
        age. We do not knowingly or intentionally collect personal information from children under 13. If you are under
        13, do not use or provide any information on or through this Website, the App, or any of their features; do not
        register on the Website, make any purchases through the Website/App, use any of the interactive or public
        comment features of this Website, or provide any information about yourself to us, including your name, address,
      ...
      <ul>
        <Li>
          Information by which you may be personally identified, such as name, residential address, postal address,
          e-mail address, telephone number, credit card numbers or other payment information, or any other identifier by
        ...
        <Li>
          Information about your internet connection and IP address, the equipment you use to access our Website, the
          browser type and language, and access dates/times, referring website addresses, and other usage details;
        </Li>
        <Li>
          Categories of personal information described in subdivision (e) of Section 1798.80 of the California Civil
          Code, such as name, physical characteristics or description, address, telephone number and medical or health
          insurance information;
        </Li>
        <Li>
          Characteristics of protected classifications under state or federal law, such as age, sex/gender, marital
          status, medical condition, and disability information;
        </Li>
        <Li>
          Information you provide on our Website to assist you with travel arrangements for yourself or another person,
          for example, your username, password, location, zip/postal code, mailing address, email address, driver's
          license, passport or other government-issued identification numbers, date of birth, gender, arrival and
          departure locations and times, airline, hotel, or car rental loyalty program numbers and other travel-related
          information;
        </Li>
      ...
      <ul>
        ...
        <Li>
          ...
          IP addresses, operating systems, browsers, and information collected through cookies (small text files stored
          in a user's web browser), web beacons (electronic images that allow us to count users who have accessed
          particular content including certain cookies), and other tracking technologies;
        </Li>
        <Li>From third parties, for example, our business partners;</Li>
        <Li>
          From third party social media services, such as Google, Facebook, Twitter, Instagram, etc. that you may use to
          interact with our Website or that allow you to share information;
        </Li>
        <Li>
          Unaffiliated parties, such as analytics companies, advertising networks, affiliates, and other third parties
          that may provide us with information so we can better understand you and provide you with information that may
      ...
      <ul>
        <Li>
          ...
          registering to use our Website, subscribing to our service, posting material, or requesting further services.
          We may also ask you for information when you report a problem with our Website.
        </Li>
        <Li>Records and copies of your correspondence (including email addresses) if you contact us.</Li>
        <Li>Your responses to surveys that we might ask you to complete for research purposes.</Li>
        <Li>
          Details of transactions you carry out through our Website and of the fulfilment of your travel reservations
          and purchases. You may be required to provide financial information before completing a booking through our
          Website.
        </Li>
        <Li>Your search queries on the Website.</Li>
      </ul>
      <P className="mt-4">
        You also may provide information to be published, displayed (hereinafter, "posted") or transmitted to other
        users of the Website or third parties (collectively, "User Contributions"). Your User Contributions are posted,
        displayed, and transmitted to others at your own risk. Although we limit access to certain pages, please be
        aware that no security measures are perfect or impenetrable. Additionally, we cannot control the actions of
        other users of the Website with whom you may choose to share your User Contributions. Therefore, we cannot and
      ...
      <ul>
        ...
        <Li>
          Information about your use of our Services, how you interact with our Services and advertisements, and
          information about data or files that have been uploaded to our Services. This information may include things
          like buttons you click, mouse movements, key strokes, page visits, dates and times of access, web beacons, and
          cookie or pixel tag information. See below for additional information about cookies, pixel tags, web beacons,
          and analytic technologies.
        </Li>
      </ul>
      <P className="mt-4">
        We also may use these technologies to collect information about your online activities over time and across
        third-party websites or other online services (behavioural tracking). The information we collect automatically
        is statistical data and may include personal information, but we may maintain it or associate it with personal
        information we collect in other ways or receive from third parties. We may use third-party vendors to assist
        with monitoring and analyzing site activity, including but not limited to Hotjar, Google Analytics & MixPanel.
        It helps us to improve our Website and deliver a better and more personalized service, including by enabling us
        to:
      </P>
      <ul>
      ...
      <P className="mt-4">
        We may use cookies and other similar technology for automatic data collection. Cookies are small pieces of text
        sent as files to your computer or mobile device when you visit most websites. Cookies are either session cookies
        or persistent cookies. Session cookies enable sites to recognize and link the actions of a user during a
        browsing session and expire at a session. Persistent cookies help us recognize you as an existing user and these
        cookies are stored on your system or device until they expire or are deleted.
      </P>
      <P>
        You can manage your cookies by setting or amending your web browser controls to accept or refuse cookies
        whenever you like, but if you do choose to reject certain cookies, your access to some features and
        functionality of our website may be restricted. Certain cookies are required or "essential" for our site to
        function as intended. These essential cookies are necessary for you to use certain features of our site such as
        accessing your account and managing your reservations. You are not able to opt out of or reject essential
        cookies.
      </P>
      <P>The technologies we use for this automatic data collection may include:</P>
      <ul>
        <Li>
          <strong>Cookies (or browser or mobile cookies).</strong> A cookie is a small file placed on the hard drive of
          your computer. You may refuse to accept browser cookies by activating the appropriate setting on your browser.
        ...
        <Li>
          <strong>Web Beacons.</strong> Pages of our Website and our e-mails may contain small electronic files known as
      ...
      <P>
        Some content, applications, and features, including without limitation advertisements, ticket issuance, and
        payment processing, on the Website are served by third parties, including advertisers, ad networks and servers,
        content providers, analytics companies, payment processors, your mobile device manufacturer, your mobile service
        provider, and application providers. These third parties may use cookies alone or in conjunction with web
        beacons or other tracking technologies to collect information about you when you use our website. The
      ...
      <P>
        ...
        information about how you can opt out of receiving targeted advertising from any providers, see "Choices About
      ...
      <ul>
        ...
        <Li>
          To fulfill your travel reservations, bookings, and purchases, to communicate with you regarding your
          reservations, bookings, and purchases, and to otherwise provide you with information, products, or services
        ...
        <Li>
          ...
          us, including for payment processing, billing, and collection of amounts to be paid under any such contracts;
        </Li>
        <Li>
          To notify you about changes to our Website, App, or any products or services we offer or provide though it;
        </Li>
        <Li>
          To promote our products and services by sending you marketing and advertising communications that we develop
          and believe may be of interest to you;
        </Li>
        <Li>To create, maintain, and update user accounts on our Website and authenticate you as a user</Li>
      ...
      <P className="mt-4">
        We may use the information we have collected from you to contact you about goods and services that may be of
        interest to you. For information about how you can opt out of receiving information about goods and services,
      ...
      <P>
        We may disclose aggregated information about our users, and information that does not identify any specific
        individual for business purposes, without restriction where permissible under applicable laws and regulations.
      </P>
      <P>We may disclose personal data and information that we collect, or you provide as described in this Policy:</P>
      <ul>
        ...
        <Li>
          To other third party suppliers we work with in connection with our business and the provision of our services
          to you. This includes for example, marketing agencies and/or companies that run our marketing campaigns, IT
          developers, service providers and hosting providers, third parties that manage promotions we may run, third
          party software companies, advertising providers and networks, and site analytics providers.
        </Li>
        <Li>
      ...
      <ul>
        ...
        <Li>
          If we in good faith believe disclosure is necessary or appropriate to protect your safety or the rights,
          property, or safety of Company, our customers, or others. This includes exchanging information with other
      ...
      <ul>
        <Li>
          ...
          cookies or mobile cookies, or to alert you when cookies are being sent. To learn how you can manage your Flash
          cookie settings, visit the Flash player settings on Adobe's website. If you disable or refuse cookies, please
          note that some parts of this site may be inaccessible or not function properly.
        </Li>
        <Li>
      ...
      <P className="mt-4">
        ...
        ("NAI") on NAI's website.
      </P>
      <P>
        We might rely on third parties, including Rakuten Advertising to help manage our marketing communications.
        Rakuten Advertising may collect personal information when you interact with its digital property, including IP
        addresses, digital identifiers, information about your web browsing and application usage and how you interact
        with its properties and ads for a variety of purposes, such as personalization of offers or advertisements,
        analytics about how you engage with websites or ads and other commercial purposes. For more information about
        Rakuten Advertising's collection, use, and sale of your personal data and your rights, please visit
        https://rakutenadvertising.com/legal-notices/services-privacy-policy/ or
      ...
      <P>
        We take the security and protection of your information very seriously. We have implemented industry-standard
      ...
      <P>
        Unfortunately, the transmission of information via the internet is never completely secure. Although we take all
        reasonable security measures to protect your personal information, we cannot guarantee or warrant the security
        of your personal information transmitted to us online. Any transmission of personal information is at your own
        risk. We are not responsible for circumvention of any privacy settings or security measures contained on the
        Website. If we learn that your personal information is compromised, we may notify you by email to the last known
        email address provided in the most expedient time reasonable under the circumstances, or as otherwise required
        by applicable law, provided however, we may delay notification as may be necessary while we determine the scope
        of the breach, attempt to restore reasonable integrity to our system, and cooperate with law enforcement.
      </P>
      <P>
        ...
        information in public areas of the Website. The information you share in public areas may be viewed by any user
        of the Website.
      </P>
      ...
      <P>
        We will retain your personal information in accordance with all applicable laws, and only for as long as
        necessary to fulfil the purposes set forth in this Policy. We will deidentify, aggregate, or otherwise anonymize
        your personal information prior to using it for analytical purposes or trend analysis beyond the standard
        retention period. When we delete your personal information, we use industry standard methods to ensure that
        recovery or retrieval of your information is impossible. We may keep residual copies of your personal
        information in backup systems to protect our systems from malicious loss. This data is inaccessible unless
        restored, and upon restoration, all unnecessary information will be deleted.
      </P>
      <P>The criteria we use to determine our retention periods include:</P>
      <ul>
        <Li>
          The duration of our relationship with you, including open user accounts, or recent bookings or other
          transactions you have made through us;
        </Li>
        <Li>
          Applicable laws requiring us to keep records of your transactions with us for a specific period of time;
        </Li>
        <Li>
          Current and relevant legal obligations governing how long we retain your personal information, including
          contractual obligations, litigation holds, statutes of limitations, and regulatory investigations;
        </Li>
      ...
      <P>
        Information that you provide may be transferred to, accessed, stored, and processed in the United States and
        other countries. The data protection and other laws and standards of such countries might not be as
        comprehensive as those in your country. By using the Website, you acknowledge and agree that your information
        may be transferred to such countries, including without limitation to our facilities and those third parties
        with whom we share it as described in this Policy in such countries.
      </P>
      <P>
        We restrict data transfers to those that are legally binding or essential for the provision of our business
        obligations.
      </P>

      <SectionHeading>INTERNATIONAL DATA TRANSFER</SectionHeading>
      <P>
        The personal information we process may be accessed from, processed or transferred to countries other than the
        country in which you reside. Those countries may have data protection laws that are different from the laws of
        your country.
      </P>
      <P>
      ...
      <P>
        We have taken appropriate steps and put safeguards in place to help ensure that any access, processing and/or
        transfer of your personal information remains protected in accordance with this Policy and in compliance with
        applicable data protection law. Such measures provide your personal information with a standard of protection
        that is at least comparable to that under the equivalent local law in your country, no matter where your data is
        accessed from, processed, and/or transferred to.
      </P>
      <P>Such measures include the following:</P>
      <ul>
        <Li>
          Adequacy decisions of the European Commission confirming an adequate level of data protection in respective
          non-EEA countries.
        </Li>
        <Li>
          Ensuring that the third-party partners, vendors and service providers to whom data transfers are made have
          appropriate mechanisms in place to protect your personal information. For instance, our agreements signed with
          our third-party partners, vendors and service providers incorporate strict data transfer terms (including,
          where applicable, the European Commission's Standard Contractual Clauses issued by the European Commission
          and/or United Kingdom, for transfers from the EEA/UK), and require all contracting parties to protect the
          personal information they process in accordance with applicable data protection law.
        </Li>
        <Li>
          Carrying out periodic risk assessments and implementing various technological and organizational measures to
          ensure compliance with relevant laws on data transfer.
        </Li>
      </ul>

      <SectionHeading>NOTICE OF RIGHTS TO RESIDENTS OF SPECIFIC GEOGRAPHIC LOCATIONS</SectionHeading>
      <P>
        This Section supplements the information contained in the rest of this Privacy Policy and applies solely to
        visitors, users, and others who reside in the countries and states specified within the following "Notice of
        Rights" Subsections.
      </P>
      <SubHeading>Notice of Rights of Individuals located within the EU</SubHeading>
      <P>
        Notice to individuals located within the territorial confines of the European Economic Area ("EEA"): This Policy
        and the notices contained herein are intended to comply with the EU General Data Protection Regulation
        (Regulation (EU) 2016/679) of the European Parliament and of the Council of 27 April 2016 (the "GDPR") and
        provide appropriate protection and care with respect to the treatment of your user information in accordance
        with the GDPR.
      </P>
      <P>
        We limit our collection, retention, and use of such information to that which is necessary to provide you with
        our goods and/or services and is compliant with applicable data retention laws. As a "Data Subject" within the
        meaning of GDPR, under applicable law you have certain rights that you may exercise to protect your personal
        data, which you can exercise at any time. These Data Subject rights are:
      </P>
      <ul>
        <Li>
          Right to be informed - you have the right to inquire about what personal data (about you) we process and the
          rationale for such processing.
        </Li>
        <Li>
          Right of access to information - you have the right to request a copy of the personal data that we collect and
          process for you. If we refuse your request under your right of access, we will provide you with a reason as to
          why and you will have the right to complain to a relevant data protection supervisory authority about our
          processing of your personally identifiable information.
        </Li>
        <Li>
          Right of rectification - you have a right to correct any inaccurate or incomplete data that we collect and
          process for you.
        </Li>
        <Li>
          Right to restriction of processing - where applicable, such as when there is a pending legal dispute or the
          data is being corrected, you have a right to temporarily restrict the processing of your data.
        </Li>
        <Li>
          Right to be forgotten (right to erasure) - in certain circumstances you can ask for the data we collect about
          you to be erased from our records.
        </Li>
        <Li>
          Right of portability - you have the right to have the data we collect about you to be transferred to another
          organization and for such data to be provided in a commonly used, structured, and machine-readable format.
        </Li>
        <Li>
          Right to withdraw consent - you have the right to withdraw a previously given consent for processing of your
          personal data for a specific purpose.
        </Li>
        <Li>
          Right to object - you have the right to object to certain types of processing, such as using your personal
          data for direct marketing and advertising. This also applies to profiling, where appropriate, insofar as it is
          associated with such direct marketing and advertising.
        </Li>
        <Li>
          Right to lodge complaint - you have the right make a complaint with a local supervisory authority using any
      ...
      <P>
        ...
        such bases are defined in Article 6 of the GDPR. In general, at least one of the following must apply whenever
      ...
      <ul>
        ...
        <Li>
          Public Task. The processing is necessary to perform a task in the public interest, and the task or function
          has a clear basis in law.
        </Li>
        <Li>
          Legitimate Interests. The processing is necessary for legitimate interests of the data controller, unless
      ...
      <P>
        ...
        personal information unless doing so proves impossible or would create a disproportionate effort for Cheap
        Flights. You also have the right to challenge the accuracy and completeness of the information and have that
        information amended as appropriate. Once we receive and confirm your verifiable request, we will disclose to
        you:
      </P>
      <ul>
      ...
      <P className="mt-4">
        ...
        verifiable consumer request to verify the requestor's identity or authority to make the request. We may request
        a copy of your government issued identification in order to verify you are the person whose information we
        collected, or their authorized representative.
      </P>
      <P>
        We endeavour to respond to a verifiable consumer request within 30 days of its receipt. If we require more time
        (up to 60 days), we will inform you of the reason and extension period in writing. If you have an account with
        us, we will deliver our written response to that account. If you do not have an account with us, we will deliver
        our written response by mail or electronically, at your option. The response we provide will also explain the
      ...
      <P>
        Under the California Consumer Privacy Act of 2018 ("CCPA") as amended by the California Privacy Rights Act of
      ...
      <P>
        As of January 1, 2023, you have the right to (1) request and access the personal data collected about you; (2)
        request to correct inaccuracies within your personal data; (3) request deletion of your personal data, though
        there are exceptions under the CDPA and other laws which may allow us to retain and use certain personal data
        notwithstanding your deletion request; (4) request confirmation regarding the processing of your personal data;
        and (5) obtain a copy of your personal data.
      </P>
      <P>
        We will not discriminate against you for exercising any of your CDPA rights. Unless permitted by the CDPA, we
        will not:
      </P>
      <ul>
      ...
      <P>
        As of July 1, 2023, you have the right to (1) request and access the personal data collected about you; (2)
        request to correct inaccuracies within your personal data; (3) request deletion of your personal data, though
      ...
      <P>
        Effective July 1, 2023, Connecticut residents will have certain rights around the collection, use, and sharing
        of their personal data under Connecticut's Data Privacy Act ("CDA"). In the preceding twelve (12) months,
        Tripile.com has not sold your personal data and will not do so in the future without providing you with notice
        and an opportunity to opt out of such sale as required by law. Tripile.com may engage in "targeted advertising"
        as that term is defined in the CPA and as of July 1, 2023 you will have the right to opt-out of targeted
        advertising. Tripile.com collects various categories of personal information when you use the Website and its
        Services which are described in the Section, "Information We Collect About You and How We Use It." The Section,
        "Disclosure of Your Information" describes the third parties with whom we may share personal information and
      ...
      <P>
        We may be required to modify our privacy and data protection notices due to changes in our services, changes to
        applicable laws and regulations, or for a myriad of other reasons. We therefore reserve the right to change this
        Policy at any time. It is our policy to post any changes we make to our privacy policy on this page. You are
      ...
      <P>
        You can find the date the policy was last updated at the top of the page. Any changes to this Policy will become
        effective when posted unless indicated otherwise.
      </P>
  ...
  return (
    <div className="font-sans antialiased text-foreground bg-background min-h-screen">
      <SEOHead
        ...
        description="Understand how Tripile collects, protects, and manages user privacy and personal information."
      />
