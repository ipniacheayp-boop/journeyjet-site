...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>About Tripile | Your Trusted US Travel Booking Partner</title>
        <meta
          name="description"
          content="Learn about Tripile - America's trusted travel booking platform. We help millions of travelers find the best deals on flights, hotels, and car rentals across the USA."
        />
        <meta
          name="keywords"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-3xl mx-auto">
              ...
              relaxing beach escape, a cultural adventure, or a quick weekend getaway, we're here to help you find the
          ...
          <div className="max-w-4xl mx-auto space-y-8 text-foreground/80 leading-relaxed">
            <p>
              Traveling within your budget shouldn't mean compromising on quality or comfort. That's why we bring you
              unbeatable prices on flights, hotels, and rental cars from trusted global partners.
            </p>
