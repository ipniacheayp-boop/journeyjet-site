...
/**
 * PaymentQR - Information page explaining QR payments are not available for USD
 * 
 * QR payments are only available for INR transactions.
        ...
        <Card className="max-w-md w-full mx-4">
          ...
          <CardContent className="text-center space-y-4">
            <p className="text-muted-foreground">
              QR code payments are only available for INR transactions. 
