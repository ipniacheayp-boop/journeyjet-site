...
const Terms = () => {
  useEffect(() => {
    document.title = "Terms & Conditions | Tripile.com Terms of Service";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Read Tripile.com’s terms and conditions for booking flights, hotels, and travel services. Understand your rights and responsibilities when using our travel platform.",
      );
    }
  }, []);
          ...
          <article className="max-w-4xl mx-auto prose prose-slate dark:prose-invert">
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                — is solely designed to serve and assist customers across the globe in planning their travel
                itineraries. By using the website for all your travel needs, you agree to adhere to the terms and
                conditions mentioned herein. These terms and conditions are attributed to all sorts of travel related
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                , the Company's mobile website and mobile and tablet applications (collectively, the "Website"), whether
                as a guest or a registered user. The Website is provided solely to assist you in gathering travel
                information, determining the availability of travel, related goods and services, making legitimate
                reservations or otherwise transacting business with travel suppliers, and for no other purpose.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                United States or any of its territories or possessions or Canada. By using this Website, you represent
                and warrant that you meet all of the foregoing eligibility requirements. If you do not meet all of these
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-base leading-7 text-foreground/90 mb-4">
                ...
                <li>
                  Your use of this website is limited but not restricted to making or managing travel reservation for
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                and agree to the changes. You are expected to check this page each time you access the Website so you
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Subject to these Terms of Use, the Company grants you a limited, non-exclusive and nontransferable
                license to:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-base leading-7 text-foreground/90 mb-4">
                <li>
                  Download, install, and use the App for your personal, non-commercial use on a single mobile device
                  owned or otherwise controlled by you strictly in accordance with any documentation provided and
                  amended by us from time to time in our sole discretion.
                </li>
                <li>
                  Access, stream, download, and use on such mobile device the content and services made available in or
                  otherwise accessible through the Application, strictly in accordance with the Terms of Use applicable
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                acquire any ownership interest in the App, or any other rights thereto other than to use the App in
                accordance with the license granted, and subject to all terms, conditions, and restrictions, under these
                Terms of Use. The Company and its licensors and service providers reserve and shall retain their entire
                right, title, and interest in and to the App, including all copyrights, trademarks, and other
                intellectual property rights therein or relating thereto, except as expressly granted to you in these
                Terms of Use.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                The Company may from time to time in its sole discretion develop and provide App updates, which may
                include upgrades, bug fixes, patches, other error corrections, and/or new features (collectively,
                including related documentation, "Updates"). Updates may also modify or delete in their entirety certain
                features and functionality. You agree that the Company has no obligation to provide any Updates or to
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                You shall promptly download and install all Updates, and you acknowledge and agree that the App or
                portions thereof may not properly operate should you fail to do so. You further agree that all Updates
                will be deemed part of the App and be subject to these Terms of Use.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                Act and its associated regulations. You shall not, directly or indirectly, export, re-export, or release
                the App to, or make the App accessible from, any jurisdiction or country to which export, re-export,
                release, or use is prohibited by law, rule, or regulation. You shall comply with all applicable federal
                laws, regulations, and rules, and complete all required undertakings (including obtaining any necessary
                export license or other governmental approval), prior to using, exporting, re-exporting, releasing, or
                otherwise making the App available outside the United States.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                The App is commercial computer software, as such term is defined in 48 C.F.R. §2.101. Accordingly, if
                you are an agency of the U.S. Government or any contractor therefor, you receive only those rights with
                respect to the App as are granted to all other end users under license, in accordance with (a) 48 C.F.R.
                §227.7201 through 48 C.F.R. §227.7202-4, with respect to the Department of Defense and their
                contractors, or (b) 48 C.F.R. §12.212, with respect to all other U.S. Government licensees and their
                contractors.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                We reserve the right to withdraw or amend this Website, and any service or material we provide on or
                through the Website, in our sole discretion without notice. We will not be liable if for any reason, all
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                any interactive features on the Website, is governed by our Privacy Policy, and you consent to all
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                to provide any other person with access to this Website or portions of it using your user name, password
                or other security information. You agree to notify us immediately of any unauthorized access to or use
                of your username or password or any other breach of security. You also agree to ensure that you exit
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                title or interest in or to the Website or any content on or obtained through the Website is transferred
                to you, and all rights not expressly granted are reserved by the Company. Any use of the Website not
                expressly permitted by these Terms of Use is a breach of these Terms of Use and may violate copyright,
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                The Company name, certain terms, the Company logo and all related names, logos, product and service
                names, designs and slogans are trademarks of the Company or its affiliates or licensors or other third
                parties. You must not use such marks without the prior written permission of the Company. All other
                names, logos, product and service names, designs and slogans on this Website are the trademarks of their
                respective owners.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                You may use the Website only for lawful purposes and in accordance with these Terms of Use. We reserve
                the right to revoke your access to the Website and any of our services, products, content, or properties
                at any time. If it is determined or suspected by us in our sole discretion that you are misusing or
                attempting to misuse or circumvent our Website, or are using or attempting to use our Website for any
                inappropriate or non-personal use, by engaging in any of the Prohibited Uses contained herein, we
                reserve the right to immediately terminate your access without notice and to initiate without notice
                available legal actions or proceedings to seek appropriate remedies and/or damages, including but not
                limited to lost revenue, repairs, legal fees, costs and expenses, and to seek injunctions or other
                equitable remedies.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                The following are considered Prohibited Uses. You acknowledge that a violation of any of the following
                could result in significant damages to the Company, and you agree you are liable to the Company for any
                such damages, and you will indemnify the Company in the event of any claims against the Company based on
                or arising from your violation of any of the following.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-2 text-base leading-7 text-foreground/90 mb-4">
                ...
                <li>
                  ...
                  person or entity (including, without limitation, by using e-mail addresses or user names associated
                ...
                <li>
                  To recreate or compete with the Company or to solicit or harass the Company or any of its third-party
                  partners.
                </li>
              </ul>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                materials (collectively, "User Contributions") on or through the Website. All User Contributions must
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                providing any User Contribution on the Website, you grant us and our affiliates and service providers,
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                content or accuracy of any User Contributions posted by you or any other user of the Website.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-base leading-7 text-foreground/90 mb-4">
                ...
                <li>
                  ...
                  sole discretion, including if we believe that such User Contribution violates the Terms of Use,
                ...
                <li>
                  Terminate or suspend your access to all or part of the Website for any or no reason, including without
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                anyone posting any materials on or through the Website. YOU WAIVE AND HOLD HARMLESS THE COMPANY AND ITS
                AFFILIATES, LICENSEES AND SERVICE PROVIDERS FROM ANY CLAIMS RESULTING FROM ANY ACTION TAKEN BY ANY OF
                THE FOREGOING PARTIES DURING OR AS A RESULT OF ITS INVESTIGATIONS AND FROM ANY ACTIONS TAKEN AS A
                CONSEQUENCE OF INVESTIGATIONS BY EITHER SUCH PARTIES OR LAW ENFORCEMENT AUTHORITIES.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                We do not undertake the responsibility to review material before it is posted on the Website, and cannot
                ensure prompt removal of objectionable material after it has been posted. Accordingly, we assume no
                liability for any action or inaction regarding transmissions, communications or content provided by any
                user or third party. We have no liability or responsibility to anyone for performance or nonperformance
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                opinion of the Company. We are not responsible, or liable to you or any third party, for the content or
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Upon using the Website, you will be prompted to disclose certain information about yourself, and you
                will be able to store information on our Website. Some of this information will be sent to our Travel
                Service Providers who will need this information to respond to your request for services. By providing
                this information to us, or by submitting a request, you are requesting and expressly consenting to be
                contacted by us and by our Travel Service Providers via phone, fax, email, mail, text (SMS) messaging,
                push notifications, or other reasonable means of communication, at any of your contact numbers or
                addresses irrespective of whether you are listed on any federal, state, or local "Do Not Call" lists or
                registries for the purposes of providing Services, servicing your account, reasonably addressing matters
                pertaining to your account, or for other purposes reasonably related to your services request and our
                business, including marketing-related contact.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                have provided to us is no longer your number, you agree to notify us promptly that you can no longer be
                reached at that number.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                You represent that you have received, and are authorized to convey to us, the consent of any authorized
                users on your account to be contacted by us as described in this Section. You agree that all consents
                provided in this Section will survive the cancellation of your account. You also acknowledge that Cheap
                Flights or the Travel Service Providers may record customer service calls after notice to you and with
                your consent, in order to assist you when you contact customer support services. For complete details on
                our use of your information, please see our{" "}
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                TO KNOWINGLY INPUT FALSE INFORMATION, INCLUDING BUT NOT LIMITED TO NAME, PHONE NUMBER, ADDRESS OR E-MAIL
                ADDRESS IS A VERY SERIOUS AND FRAUDULENT MATTER THAT COULD RESULT IN SIGNIFICANT COSTS AND DAMAGES
                INCLUDING INVASION OF PRIVACY RIGHTS, TO CHEAP FLIGHTS AND THE TRAVEL SERVICE PROVIDERS, AND TO
                CONSUMERS, AS WELL AS THE LOSS OF TIME, EFFORT AND EXPENSE RESPONDING TO AND PURSUING SUCH FALSE
                INFORMATION AND REQUEST, AND FURTHER, COULD RESULT IN REGULATORY FINES AND PENALTIES. ACCORDINGLY, IF
                YOU KNOWINGLY INPUT FALSE INFORMATION IN A REQUEST, INCLUDING BUT NOT LIMITED TO SOMEONE ELSE'S NAME,
                E-MAIL ADDRESS, PHYSICAL ADDRESS, OR PHONE NUMBER OR A RANDOM OR MADE-UP NAME, ADDRESS, E-MAIL, OR PHONE
                NUMBER, YOU AGREE TO FULLY INDEMNIFY AND BE LIABLE TO CHEAP FLIGHTS AND EACH TRAVEL SERVICE PROVIDER WHO
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                All purchases through our Website or other transactions for the sale of services or information formed
                through the Website or as a result of visits made by you are governed by our Terms of Sale, which are
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                Website. All such additional terms and conditions are hereby incorporated by this reference into these
                Terms of Use.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                all respects with the Content Standards set out in these Terms of Use. You agree to cooperate with us in
                causing any unauthorized framing or linking immediately to cease. We reserve the right to withdraw
                linking permission without notice. We may disable all or any social media features and any links at any
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                The owner of the Website is based in the state of New Jersey in the United States of America. We provide
                this Website for use only by persons located in the United States of America and Canada. We make no
                claims that the Website or any of its content is accessible or appropriate outside of the United States
                of America. Access to the Website may not be legal by certain persons or in certain countries. If you
                access the Website from outside the United States of America, you do so on your own initiative and are
                responsible for compliance with local laws. If you are a resident in a country other than the United
                States of America or Canada, you must not transact business with or through the Website.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                If you use the Website to submit requests for or on behalf of a third-party such as a family member or a
                traveling companion, you are responsible for any error in the accuracy of information provided in
                connection with such use; including, but not limited to, the billing address and phone number of the
                credit card holder. These should match what is on file with their financial institution. In addition,
                you must inform the third-party of all terms and conditions (including these Terms of Use) applicable to
                all products or services acquired through this website including all rules and restrictions applicable
                thereto.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                If you are using this Website for or on behalf of a third-party, you agree to indemnify and hold each
                Covered Party harmless from and against any and all liabilities, losses, damages, suits and claims
                (including the costs of defense), relating to the third-party's or your failure to fulfill any of its
                obligations as described above. You are directly responsible for any request submitted including for
                total charges and performance obligations. You acknowledge that in no event will Company be required to
                refund any amounts.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                You understand that we cannot and do not guarantee or warrant that files or other information available
                for downloading from the internet or the Website will be free of viruses or other destructive code. You
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, WE WILL NOT BE LIABLE FOR ANY LOSS OR DAMAGE
                CAUSED BY A DISTRIBUTED DENIAL-OF-SERVICE ATTACK, VIRUSES OR OTHER TECHNOLOGICALLY HARMFUL MATERIAL THAT
                MAY INFECT YOUR COMPUTER EQUIPMENT, COMPUTER PROGRAMS, DATA OR OTHER PROPRIETARY MATERIAL DUE TO YOUR
                USE OF THE WEBSITE OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE OR TO YOUR DOWNLOADING OF ANY
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                OR OTHERWISE MADE AVAILABLE ON AN "AS IS" AND "AS AVAILABLE" BASIS, WITHOUT ANY WARRANTIES OF ANY KIND,
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                SUITABLE, AVAILABLE, ACCURATE, RELIABLE, COMPLETE, ERROR-FREE OR UNINTERRUPTED, THAT DEFECTS WILL BE
                CORRECTED, THAT OUR WEBSITE OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                THE COMPANY IS NOT RESPONSIBLE FOR ANY FAILURES CAUSED BY SERVER ERRORS, MISDIRECTED TRANSMISSIONS,
                FAILED INTERNET CONNECTIONS, INTERRUPTIONS IN THE TRANSMISSION OR RECEIPT OF TICKET ORDERS OR, ANY
                COMPUTER VIRUS OR OTHER TECHNICAL DEFECT, WHETHER HUMAN OR TECHNICAL IN NATURE. THE COMPANY HEREBY
                DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, STATUTORY OR OTHERWISE, INCLUDING BUT
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                TO THE EXTENT PERMITTED BY LAW AND NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, IN NO
                EVENT WILL THE COMPANY, ITS AFFILIATES OR THEIR LICENSORS, SERVICE PROVIDERS, EMPLOYEES, AGENTS,
                OFFICERS OR DIRECTORS (EACH A "COVERED PARTY" AND COLLECTIVELY, THE "COVERED PARTIES") BE LIABLE FOR
                DAMAGES OF ANY KIND, UNDER ANY LEGAL THEORY, ARISING OUT OF OR IN CONNECTION WITH YOUR USE, OR INABILITY
                TO USE, THE WEBSITE, ANY WEBSITES LINKED TO IT, ANY CONTENT ON THE WEBSITE OR SUCH OTHER WEBSITES OR ANY
                SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE OR SUCH OTHER WEBSITES, INCLUDING ANY DIRECT, INDIRECT,
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                ...
                your violation of these Terms of Use or your use of the Website, including, but not limited to, your
                User Contributions, any use of the Website's content, services and products other than as expressly
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                At Company's sole discretion, it may require You to submit any disputes arising from the use of these
                Terms of Use or the Website, including disputes arising from or concerning their interpretation,
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                No waiver by the Company of any term or condition set forth in these Terms of Use shall be deemed a
                further or continuing waiver of such term or condition or a waiver of any other term or condition, and
                any failure of the Company to assert a right or provision under these Terms of Use shall not constitute
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                All flight bookings are subject to availability and confirmation by the airline. Prices displayed on our
                website are dynamic and may change without notice. We recommend completing your booking as soon as
                possible to secure the displayed price.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Passengers must comply with all airline requirements, including but not limited to: valid
                identification, visa requirements, health documentation, and baggage restrictions. It is the passenger's
                responsibility to verify all requirements with the airline and relevant authorities.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Cancellation and change policies vary by airline and fare type. Please review the specific terms
                associated with your booking before completing your purchase.
              </p>

              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Hotel Booking Terms</h3>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Hotel reservations are subject to the terms and conditions of the individual hotel property. Check-in
                and check-out times, cancellation policies, and any special requirements are set by the hotel and should
                be reviewed before booking.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Additional charges such as resort fees, parking fees, taxes, and incidental charges may apply and are
                the responsibility of the guest. These charges are typically paid directly to the hotel.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                The hotel reserves the right to refuse service or cancel reservations for cause, including but not
                limited to: failure to meet age requirements, providing false information, or violating hotel policies.
              </p>

              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Car Rental Terms</h3>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Car rentals are provided by third-party vendors and are subject to their terms and conditions. Rental
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Fuel policies, mileage limits, and cross-border travel restrictions vary by rental company and location.
                Review the rental agreement carefully before accepting the vehicle.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                All prices are displayed in USD unless otherwise specified. Payment must be made in full at the time of
                booking unless otherwise stated. We accept major credit cards, debit cards, and other payment methods as
                displayed during checkout.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                By providing your payment information, you authorize us and our service providers to charge your payment
                method for the total amount of your purchase, including any applicable taxes, fees, and surcharges.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                In the event of payment failure or chargeback, we reserve the right to cancel your booking and pursue
                collection of any outstanding amounts, including reasonable collection costs and legal fees.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Cancellation and refund policies vary depending on the type of service booked and the specific terms set
                by our service providers (airlines, hotels, car rental companies, etc.).
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Non-refundable bookings cannot be cancelled for a refund except where required by law. Partially
                refundable bookings may incur cancellation fees as specified at the time of booking.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                We strongly recommend purchasing travel insurance to protect your investment. Travel insurance can
                provide coverage for trip cancellation, medical emergencies, lost baggage, travel delays, and other
                unforeseen circumstances.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Travel insurance policies are underwritten by third-party insurance providers and are subject to their
                terms, conditions, and exclusions. Please read the policy documents carefully to understand what is and
                is not covered.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-7 text-foreground/90 mb-4">
                Special requests such as dietary requirements, accessibility needs, room preferences, or seat
                assignments are not guaranteed and are subject to availability. We will communicate your requests to
                service providers, but we cannot guarantee they will be fulfilled.
              </p>
              <p className="text-base leading-7 text-foreground/90 mb-4">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-base leading-7 text-foreground/90 mb-4">
                ...
                <li>
                  The booking customer warrants and represents that the person who signs contract with the featured car
                  park service is the authorized custodian of the vehicle.
                </li>
                <li>
                  The featured car park will accept liability for proven acts of their negligence. Claims cannot be
                  considered once your vehicle has left the site.
                </li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-2 text-base leading-7 text-foreground/90 mb-4">
                ...
                <li>
                  Please ensure that you have removed all your possessions before parking the car. Leave only the
                  keys/codes required to move your vehicle, only when asked to do so by the authority in charge.
                </li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-2 text-base leading-7 text-foreground/90 mb-4">
                ...
                <li>
                  ...
                  concessionary rate. This will not affect any reservation made before the change. The applicable tariff
                  will be shown on your booking confirmation.
                </li>
                <li>
                  All parking charges must be paid in full before your vehicle can be removed from our featured car
                  park. We shall have the right to retain a vehicle until such time as all sums due are paid. We will
              ...
              <ul className="list-disc pl-6 space-y-2 text-base leading-7 text-foreground/90 mb-4">
                ...
                <li>
                  Please be absolutely sure of the cancellation and payment terms and conditions for your booking at the
                  time of purchase. All services featured on this website consist of different payment, cancellation and
