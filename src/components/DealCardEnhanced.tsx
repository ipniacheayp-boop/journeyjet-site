        ...
        <div className="p-5 space-y-3 flex-1 flex flex-col">
          ...
          <div className="mt-auto pt-3 space-y-3">
            <div className="flex items-end justify-between">
              <div>
                <p className="text-xs text-muted-foreground line-through">${Math.ceil(deal.originalPrice)}</p>
                <div className="flex items-baseline gap-1">
                  <span className="text-3xl font-black text-primary">${Math.ceil(deal.price)}</span>
                  <span className="text-sm text-muted-foreground">/person</span>
                </div>
              </div>
              <p className="text-xs text-green-600 dark:text-green-400 font-semibold">
                Save ${Math.ceil(deal.originalPrice - deal.price)}
              </p>
            </div>
