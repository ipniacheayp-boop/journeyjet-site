      ...
      <div className="container mx-auto px-4">
        ...
        >
          {stats.map((stat) => (
            ...
            >
              <div className={`inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-card shadow-md mb-4 ${stat.color}`}>
        ...
        <div className="mt-10 md:mt-12 flex flex-wrap justify-center items-center gap-6 md:gap-8 opacity-70">
